<template>
    <main class="main contact-two">
        ...
        <div class="container container-not-boxed mb-0">
            <div id="map" class="mb-0"> 
                <gmap-map
        ...
        <div class="container mb-0">
            <div class="row pt-1 mt-1 pb-2 pb-2">
                <div class="col-md-6">
                    <h2 class="heading ls-0 mb-1">
                ...
                <div class="col-md-6">
                    ...
                    <div class="contact-info mb-2 pt-2">
                        <h2 class="contact-title">
                    ...
                    <div class="contact-time pt-2">
                        ...
                        <div class="porto-sicon-box d-flex align-items-center">
                            ...
                            <h3 class="porto-sicon-title">Sunday - Closed</h3>
                        </div>
                    </div>
                </div>
            </div>
