<template>
    <main class="main mt-2">
        ...
        <div class="container account-container custom-account-container container-not-boxed">
            <div class="row">
                <div class="sidebar widget widget-dashboard col-lg-3 order-0" sticky-container>
                    <div v-sticky="isSticky" sticky-offset="{top: 70}">
                    ...
                    >
                        <div class="dashboard-content">
                            <p>
                                ...
                                <nuxt-link to="/pages/login" class="btn btn-link">Log out</nuxt-link>)
                            </p>
                        ...
                        <div class="addresses-content">
                            ...
                            <div class="row">
                                <div class="address col-md-6">
                                    ...
                                    <div
                                        class="address-box"
                                    >You have not set up this type of address yet.</div>
